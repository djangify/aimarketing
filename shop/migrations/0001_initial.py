    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(blank=True, help_text='Upload a PDF or ZIP file. Use ZIP for bundles.', null=True, storage=django.core.files.storage.FileSystemStorage(base_url='/media/secure/', location='C:\\Dev\\Projects\\aimarketing\\media\\secure'), upload_to='products/files/')),
                ('preview_file', models.FileField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(base_url='/media/public/', location='C:\\Dev\\Projects\\aimarketing\\media\\public'), upload_to='products/previews/')),
                ('preview_image', models.ImageField(blank=True, null=True, storage=django.core.files.storage.FileSystemStorage(base_url='/media/public/', location='C:\\Dev\\Projects\\aimarketing\\media\\public'), upload_to='products/images/')),
                ('video_url', models.URLField(blank=True, help_text='Optional YouTube or Vimeo URL to display on the product page', null=True)),
                ('video_file', models.FileField(blank=True, help_text='Upload a short MP4 file to display as product video', null=True, storage=django.core.files.storage.FileSystemStorage(base_url='/media/public/', location='C:\\Dev\\Projects\\aimarketing\\media\\public'), upload_to='products/videos/')),
