...
DEFAULT_FROM_EMAIL = env(
    "DEFAULT_FROM_EMAIL", default="support@aimarketingplatform.app"
)
SERVER_EMAIL = env("SERVER_EMAIL", default="support@aimarketingplatform.app")

# Admin configuration
ADMINS = [
    (
        env("ADMIN_NAME", default="Admin"),
        env("ADMIN_EMAIL", default="support@aimarketingplatform.app"),
    ),
]
...
SITE_URL = env("SITE_URL", default="https://www.aimarketingplatform.app")
