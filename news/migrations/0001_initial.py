    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(unique=True)),
                ('introduction', tinymce.models.HTMLField(blank=True, help_text='Introduction', null=True, verbose_name='Introduction')),
                ...
                ('ad_image', models.ImageField(blank=True, null=True, upload_to='news/ads/')),
